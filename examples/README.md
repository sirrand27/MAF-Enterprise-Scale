...
- [Enable Service Principal to create Azure foundations](https://github.com/Azure/Enterprise-Scale/wiki/Create-Landingzones#enable-service-principal-to-create-Azure Foundations)
- [Landing zone creation](./Azure Foundations)
