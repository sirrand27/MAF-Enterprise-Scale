...
The ALZ team will assess solutions for parity ongoing. Please review the AMA parity Gaps table [here](./MAF-AMA-Update#table-ama-parity-status) for the latest updates and guidance.
