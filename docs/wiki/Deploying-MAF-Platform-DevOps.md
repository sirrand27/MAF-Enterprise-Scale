...
Consequently, users interested in Platform DevOps and Automation, are encouraged to use either the respective [ALZ Bicep Modules](https://github.com/Azure/MAF-Bicep), or the [ALZ Terraform Accelerator](https://aka.ms/alz/accelerator).
