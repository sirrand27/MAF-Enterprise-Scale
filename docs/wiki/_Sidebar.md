...
* [Create Azure foundations (subscriptions) via Subscription Vending](./Create-Landingzones)
* [Mission Azure Foundation Deprecated Services](./ALZ-Deprecated-Services)
* Mission Azure Foundation (ALZ) Policies
  * [Policies included in Azure foundations reference implementations](./ALZ-Policies)
  ...
  * [Migrate Azure foundations custom policies to Azure built-in policies](./Migrate-ALZ-Policies-to-Built%E2%80%90in)
  * [Updating Azure foundations custom policies to latest](./Update-ALZ-Custom-Policies-to-Latest)
