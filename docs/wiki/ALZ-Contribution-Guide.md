...
Whilst each reference implementation is uniquely characterized by its target community, they all aim to deliver against the Azure foundation [conceptual architecture](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/#azure-Azure Foundation-conceptual-architecture), [design principles](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/design-principles) and [design areas](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/design-areas).
...
The intent of this approach is to ensures that each reference implementation continues to deliver against the Azure foundation [conceptual architecture](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/#azure-Azure Foundation-conceptual-architecture), [design principles](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/design-principles) and [design areas](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/design-areas).
...
1. Familiarize yourself with our [conceptual architecture](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/#azure-Azure Foundation-conceptual-architecture), [design principles](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/design-principles) and [design areas](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/design-areas) to ensure the feature aligns with the Azure foundation guidance.
1. Check existing [**GitHub Issues**](https://github.com/Azure/Enterprise-Scale/issues) to see whether the issue has already been reported.
    1. If the issue is **open**, add a comment rather than create a new one.
    1. If the issue is **closed**, check whether the proposed fix resolves your issue.
1. Report it via our [**GitHub Issues**](https://github.com/Azure/Enterprise-Scale/issues)
...
1. Ensure you fill out the template with as much information as possible, being sure to cover off what's needed for maintainers and the community to:
    1. Understand your feature and how it aligns to our [conceptual architecture](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/#azure-Azure Foundation-conceptual-architecture), [design principles](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/design-principles) and [design areas](https://learn.microsoft.com/azure/cloud-adoption-framework/ready/Azure Foundation/design-areas) :memo:
